...
class TransformControlsGizmo extends Object3D {
  constructor() {
    ...
    const gizmoCombined = {
      XT: [
        [
          new Mesh(arrowGeometry, matRedArrow),
          [0.2, 0, 0],
          [0, 0, -Math.PI / 2],
        ],
      ],
      XR: [
        [
          new Mesh(CircleGeometry(0.15, 0.5), matRed),
          null,
          [0, Math.PI / 2, Math.PI / 2],
        ],
      ],
      YT: [[new Mesh(arrowGeometry, matGreenArrow), [0, 0.2, 0]]],
      YR: [
        [
          new Mesh(CircleGeometry(0.15, 0.5), matGreen),
          null,
      ...
      ZT: [
        [
          new Mesh(arrowGeometry, matBlueArrow),
          [0, 0, 0.2],
          [Math.PI / 2, 0, 0],
        ],
      ],
